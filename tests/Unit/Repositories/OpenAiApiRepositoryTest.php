...
class OpenAiApiRepositoryTest extends TestCase
{
    protected function setUp(): void
    {
        parent::setUp();

        Config::set('ai.openai.api_key', 'test-api-key');
        Config::set('ai.openai.model');
    ...
    public function test_extractPrefectureByAi_成功時は都道府県名を返す()
    {
        ...
        $repository = new OpenAiApiRepository();
        $result = $repository->extractPrefectureByAi('東京都渋谷区神南1-1-1');
    ...
    public function test_extractPrefectureByAi_API失敗時は例外をスロー()
    {
        ...
        $repository->extractPrefectureByAi('東京都渋谷区神南1-1-1');
    }
    ...
    public function test_extractPrefectureByAi_レスポンスに都道府県名が含まれていない場合はnullを返す()
    {
        ...
        $repository = new OpenAiApiRepository();
        $result = $repository->extractPrefectureByAi('関東地方のどこか');
